...
QUERY_SETS = {
    ...
    # Note all query sets assume all tables, unless the ONLY or EXCLUDE option is uses
    'v1_query_set': {
        'vars': {
            'TRIGGER_DATE': '10-31-2014',
        },
        'dogs': {'created_at': {'$gt': 'TRIGGER_DATE'}},
        'cats': {'created_at': {'$gt': 'TRIGGER_DATE'}, 'cat_type': 'tabby'},
        'accounts': {'created_at': {'$gt': 'TRIGGER_DATE'}}
    },

    'v2_query_set': {
        'vars': {
            'TRIGGER_DATE': 'prompt_date',
        },
        'dogs': {'created_at': {'$gt': 'TRIGGER_DATE'}},
        'cats': {'created_at': {'$gt': 'TRIGGER_DATE'}, 'cat_type': 'tabby'},
        'accounts': {'created_at': {'$gt': 'TRIGGER_DATE'}}
    ...
    'v3_query_set': {
        'dogs': {'created_at': {'$gt': '3_weeks_ago'}},
        'accounts': {'_id': {'$in': 'PROMPT_accounts'}},
        'cats': {},
    },
